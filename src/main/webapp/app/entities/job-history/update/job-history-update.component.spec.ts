...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 16359 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 20065 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 3841 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 8839 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 15170 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 32505 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 25802 };
      jobHistory.job = job;
      const department: IDepartment = { id: 2819 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 29956 };
      jobHistory.employee = employee;
